...
实现resnet-50-torch模型的推理服务，支持grpc和http两种协议，通过自定义前后处理器可以实现接口层输入图片，直接返回label输出。支持打开dynamic
...
'''输出结果如下：
I20231220 23:27:41.347786 44814 grpc_client.cc:52] Predict label: Samoyed, latency: 65245 us
'''
