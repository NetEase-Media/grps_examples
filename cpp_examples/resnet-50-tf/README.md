...
'''输出结果如下：
I20231220 17:36:31.158865 13640 grpc_client.cc:52] Predict label: tabby, latency: 50314 us
'''

# 运行brpc c++ client，使用rpc端口（需要将conf/server.yml framework改为"http+brpc"并使用新的配置重启服务）
# ./build/RelWithDebInfo_install/bin/brpc_client --server=0.0.0.0:8021 --img_path=../../data/tabby.jpeg
'''输出结果如下：
I1220 17:40:13.098595 14881 brpc_client.cc:59] Predict label: tabby, latency: 32843 us
'''
